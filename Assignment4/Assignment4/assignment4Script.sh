...
OMP_SCHEDULE="static" ./a.out 100000000 1
OMP_SCHEDULE="static" ./a.out 100000000 2
OMP_SCHEDULE="static" ./a.out 100000000 4
OMP_SCHEDULE="static" ./a.out 100000000 8
OMP_SCHEDULE="static" ./a.out 100000000 16
OMP_SCHEDULE="dynamic,1" ./a.out 100000000 1
OMP_SCHEDULE="dynamic,1" ./a.out 100000000 2
OMP_SCHEDULE="dynamic,1" ./a.out 100000000 4
OMP_SCHEDULE="dynamic,1" ./a.out 100000000 8
OMP_SCHEDULE="dynamic,1" ./a.out 100000000 16
OMP_SCHEDULE="dynamic,1000" ./a.out 100000000 1
OMP_SCHEDULE="dynamic,1000" ./a.out 100000000 2
OMP_SCHEDULE="dynamic,1000" ./a.out 100000000 4
OMP_SCHEDULE="dynamic,1000" ./a.out 100000000 8
OMP_SCHEDULE="dynamic,1000" ./a.out 100000000 16
OMP_SCHEDULE="dynamic,10000" ./a.out 100000000 1
OMP_SCHEDULE="dynamic,10000" ./a.out 100000000 2
OMP_SCHEDULE="dynamic,10000" ./a.out 100000000 4
OMP_SCHEDULE="dynamic,10000" ./a.out 100000000 8
OMP_SCHEDULE="dynamic,10000" ./a.out 100000000 16