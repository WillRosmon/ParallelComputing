...
g++ findFirst.cpp -fopenmp -std=c++11
./a.out 1000000 5000 1
./a.out 1000000 5000 2
./a.out 1000000 5000 4
./a.out 1000000 5000 8
./a.out 1000000 5000 16

g++ prefixSum.cpp -fopenmp -std=c++11
./a.out 1000000 1
./a.out 1000000 2
./a.out 1000000 4
./a.out 1000000 8
...
g++ integration.cpp -fopenmp -std=c++11
...
OMP_SCHEDULE="static" ./a.out 1000000 1
OMP_SCHEDULE="static" ./a.out 1000000 2
OMP_SCHEDULE="static" ./a.out 1000000 4
OMP_SCHEDULE="static" ./a.out 1000000 8
OMP_SCHEDULE="static" ./a.out 1000000 16
OMP_SCHEDULE="dynamic,1" ./a.out 1000000 1
OMP_SCHEDULE="dynamic,1" ./a.out 1000000 2
OMP_SCHEDULE="dynamic,1" ./a.out 1000000 4
OMP_SCHEDULE="dynamic,1" ./a.out 1000000 8
OMP_SCHEDULE="dynamic,1" ./a.out 1000000 16
OMP_SCHEDULE="dynamic,1000" ./a.out 1000000 1
OMP_SCHEDULE="dynamic,1000" ./a.out 1000000 2
OMP_SCHEDULE="dynamic,1000" ./a.out 1000000 4
OMP_SCHEDULE="dynamic,1000" ./a.out 1000000 8
OMP_SCHEDULE="dynamic,1000" ./a.out 1000000 16
OMP_SCHEDULE="dynamic,10000" ./a.out 1000000 1
OMP_SCHEDULE="dynamic,10000" ./a.out 1000000 2
OMP_SCHEDULE="dynamic,10000" ./a.out 1000000 4
OMP_SCHEDULE="dynamic,10000" ./a.out 1000000 8
OMP_SCHEDULE="dynamic,10000" ./a.out 1000000 16